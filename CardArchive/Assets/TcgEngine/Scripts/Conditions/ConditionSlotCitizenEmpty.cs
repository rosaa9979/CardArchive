...
namespace TcgEngine
{
    ...
    [CreateAssetMenu(fileName = "condition", menuName = "TcgEngine/Condition/SlotCitizenEmpty", order = 11)]
    public class ConditionSlotCitizenEmpty : ConditionData
    {
        [Header("Slot Is Empty (Citizen)")]
