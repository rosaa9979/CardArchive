...
{
    /// <summary>
    /// Desc value from a built-in card stat (attack/hp/mana/range). Uses the runtime current value when a
    /// Card is available, otherwise the card definition's base value.
    /// </summary>

    [CreateAssetMenu(fileName = "desc_value", menuName = "TcgEngine/DescValue/CardStat", order = 10)]
    public class DescValueCardStat : DescValueData
    {
