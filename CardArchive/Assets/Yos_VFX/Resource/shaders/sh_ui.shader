	...
	LOD 0
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				#ifdef _USEALPHA_ON
				float staticSwitch22 = tex2DNode2.a;
				#else
				float staticSwitch22 = tex2DNode2.r;
				#endif
				float saferPower14 = abs( staticSwitch22 );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( pow( saferPower14 , _PowerTex ) * _Colorhd.rgb * input.ase_color.a );
				float Alpha = saturate( ( staticSwitch22 * _Alpha ) );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input ) : SV_Target
			{
				...
				surfaceDescription.Alpha = saturate( ( staticSwitch22 * _Alpha ) );
				#if defined( _ALPHATEST_ON )
...
WireConnection;3;2;16;4
WireConnection;19;0;17;0
WireConnection;5;2;3;0
WireConnection;5;3;19;0
ASEEND*/
//CHKSM=932EDD5A30611F3F93FF8DBCB728517F476798C6